...
from source.data_extraction_section_creator import extract_heizenergie_liegenschaft_kwh, extract_heizenergie, \
    extract_kaltwasser, extract_kaltwasser_liegenschaft_m3


class MyTestCase(unittest.TestCase):
    _filepath_of_test_input_heizenergie = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'resources',
                                                       'selenium_code_first_step_result.html')
    _filepath_of_test_input_kaltwasser = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'resources',
        ...
        expected = {
            ...
            'verbrauchswert_liegenschaft_geraete_kwh': {
                'datapoints': {'2022-09-01T00:00:00': 1.6, '2022-08-01T00:00:00': 1.23, '2022-07-01T00:00:00': 1.28,
                               '2022-06-01T00:00:00': 1.24, '2022-05-01T00:00:00': 1.63, '2022-04-01T00:00:00': 3.44,
                               '2022-03-01T00:00:00': 4.56, '2022-02-01T00:00:00': 5.46, '2022-01-01T00:00:00': 7.27}
            }
        }
    ...
    def test_extract_kaltwasser_liegenschaft(self):
        ...
        expected = {
            'verbrauchswert_liegenschaft_geraete_wasser': {
                'datapoints': {'2022-09-01T00:00:00': 0.08, '2022-08-01T00:00:00': 0.08, '2022-07-01T00:00:00': 0.08,
                               '2022-06-01T00:00:00': 0.07, '2022-05-01T00:00:00': 0.07, '2022-04-01T00:00:00': 0.08,
                               '2022-03-01T00:00:00': 0.08, '2022-02-01T00:00:00': 0.07, '2022-01-01T00:00:00': 0.09}
            },
            'verbrauchswert_liegenschaft_qm_wasser': {
                'datapoints': {'2022-09-01T00:00:00': 5.888, '2022-08-01T00:00:00': 5.888,
                               '2022-07-01T00:00:00': 5.888, '2022-06-01T00:00:00': 5.152,
                               '2022-05-01T00:00:00': 5.152, '2022-04-01T00:00:00': 5.888,
    ...
    def test_extract_kaltwasser_eigen(self):
        ...
        expected = {'Kaltwasser': {'Raum / Zähler-Nr.': 'Abstellkammer (2067626)',
